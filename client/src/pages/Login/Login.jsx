...
const Login = () => {
    ...
    return (
        <>
            <Helmet>
                <title>Yousra's Delightful Hub | Login</title>
                    ...
                    <div className="card md:w-1/2 max-w-sm shadow-2xl bg-base-100">
                        <form onSubmit={handleLogin} className="card-body">
                            ...
                            <div className="form-control mt-6">
                                {/* Make disabled disable */}
                                <input disabled={false} type="submit" className="btn btn-primary" value="Login" />
                            </div>
                            <p className="mt-2 font-medium">New here? <Link to="/signup"><span className="text-blue-800">Register</span></Link></p>
